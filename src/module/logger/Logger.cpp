...
extern "C" {
    ...
    int __real_printf(const char *format, ...){ return 0 ;}
    int __real_vprintf(const char *format, va_list args){ return 0 ;}
    ssize_t __real_write(int fd, const void *buf, size_t count){ return 0 ;}
